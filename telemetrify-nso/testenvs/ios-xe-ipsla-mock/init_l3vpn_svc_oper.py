...
with ncs.maapi.single_write_trans('admin', 'system', db=_ncs.OPERATIONAL) as t:
    ...
    service.vars.lan_interface.name = 'GigabitEthernet2'
    service.vars.lan_interface.ipv4_address = "10.1.1.2" #SITE_VARIABLES[site_id]['wan_prefix']
    # service.vars.lan_interface.ipv4_prefix_length = "24"

    service = ncs.maagic.get_node(t, "/l3vpn-svc/sites/site{2000000002.000229}/site-network-accesses/site-network-access{001.2000000002}")
    # site = service._parent._parent._parent
    # site_id = site.site_id
    # sap_vpn_id, sap_no = site_id.split('.')
    # service.vars.site_id = sap_no.lstrip('0')
    service.vars.hostname = "de-bsp-berlin-cpe-1" #SITE_VARIABLES[site_id]['hostname']
    service.vars.lan_interface.name = 'GigabitEthernet2'
    service.vars.lan_interface.ipv4_address = "10.1.3.2" #SITE_VARIABLES[site_id]['wan_prefix']
    # service.vars.lan_interface.ipv4_prefix_length = "24"
    ...
    service.vars.lan_interface.name = 'GigabitEthernet2'
    service.vars.lan_interface.ipv4_address = "10.1.2.2" #SITE_VARIABLES[site_id]['wan_prefix']
    # service.vars.lan_interface.ipv4_prefix_length = "24"
